...
function Quick()
{
    ...
    document.getElementById("Info_Algo").innerText = "Quick sort is a fast, divide-and-conquer sorting algorithm that selects a pivot element and partitions the array around it. It recursively sorts the two resulting subarrays. It has an average time complexity of O(n log n), making it efficient for large datasets. However, in the worst case, it can have a time complexity of O(n^2)."
    c_delay=0;
